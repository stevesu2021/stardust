  ...
  "pages": [
    {
      ...
      "style": {
        "navigationBarTitleText": "星尘",
        "navigationStyle": "custom",
        "mp-weixin": {
          "navigationBarTitleText": "星尘 - 星座占卜"
        },
        "h5": {
          "navigationBarTitleText": "星尘 - 专业占卜社交平台"
        }
      }
    }
  ],
  ...
  static getShareConfig(type: string, data: any): any {
    ...
    switch (type) {
      case 'prayer':
        return {
          ...baseConfig,
          title: `我在星尘祈愿${data.targetName || '复合'}，快来为我祝福吧！`,
...
export class PaymentService {
  ...
  private static async appPay(params: any): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      uni.requestPayment({
        provider: 'applepay', // 或 'alipay', 'wxpay'
...
export class DebugHelper {
  ...
  static logPlatformInfo(): void {
    ...
    console.log('系统:', system.system)
    console.log('品牌:', system.brand)
    console.log('型号:', system.model)
    console.log('屏幕宽:', system.screenWidth)
    console.log('屏幕高:', system.screenHeight)
    console.log('状态栏高度:', system.statusBarHeight)
    console.log('导航栏高度:', system.safeArea?.top)
  }
  ...
  static logDeviceInfo(): void {
    ...
    console.log('可用存储:', (storageInfo.limitSize - storageInfo.currentSize), 'KB')
  }
}
```
...
#### 8.1 H5 部署配置
```javascript
// frontend/vite.config.ts (生产环境优化)
